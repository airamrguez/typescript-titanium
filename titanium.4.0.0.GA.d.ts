/*
   Typescript Titanium - 4.0.0.GA
   Typescipt-Titanium may be freely distributed under the MIT license.
   This source code was auto-generated (Sat Sep 26 2015 20:59:56 GMT-0400 (EDT)}}).
...
interface ITitaniumUIListSection {
    ...
    getItemAt (itemIndex : number) : IVoid;
...
interface ITitaniumUIPicker {
    ...
    updateLayout (params : any) : IVoid;
    convertPointToView (point : IPoint, destinationView : ITitaniumUIView) : IPoint;
    getSelectedRow (index : number) : IVoid;
...
interface ITitaniumUIIOS {
    ...
    fireEvent (name : string, event : any) : IVoid;
    applyProperties (props : any) : IVoid;
    createTransitionAnimation (transition : ITransitionAnimationParam) : IVoid;
...
interface ITitaniumAnalytics {
    ...
    featureEvent (name : string, data? : any) : IVoid;
...
interface ITitaniumCalendarEvent {
    ...
    removeRecurenceRule (rule : ITitaniumCalendarRecurrenceRule) : IVoid;
    getBubbleParent () : boolean;
    setBubbleParent (bubbleParent : boolean) : IVoid;
    getApiName () : string;
    getLifecycleContainer () : ITitaniumUIWindow;
    ...
    setRecurenceRule (recurenceRule : ITitaniumCalendarRecurrenceRule) : IVoid;
    getRecurenceRules () : any[];
    setRecurenceRules (recurenceRules : any[]) : IVoid;
    getVisibility () : number;
}
...
interface ITitaniumDatabaseResultSet {
    ...
    applyProperties (props : any) : IVoid;
    close () : IVoid;
    field (index : number, type? : number) : IVoid;
    fieldByName (name : string, type? : number) : IVoid;
    fieldCount () : number;
...
interface ITitaniumNetworkSocketUDP {
    ...
    fireEvent (name : string, event : any) : IVoid;
    applyProperties (props : any) : IVoid;
    start (port : number) : IVoid;
    stop () : IVoid;
    sendString (port : number, host : string, data : string) : IVoid;
    sendBytes (port : number, host : string, data : any[]) : IVoid;
    getApiName () : string;
    getPort () : number;
    setPort (port : number) : IVoid;
    getStarted () : (...args : any[]) => any;
    setStarted (started : (...args : any[]) => any) : IVoid;
    getData () : (...args : any[]) => any;
    setData (data : (...args : any[]) => any) : IVoid;
    getError () : (...args : any[]) => any;
    setError (error : (...args : any[]) => any) : IVoid;
}
...
interface ITitaniumStream {
    ...
    readAll (sourceStream : ITitaniumIOStream, buffer? : ITitaniumBuffer, resultsCallback? : (...args : any[]) => any) : IVoid;
...
declare function createJSON (parameters? : IGlobalJSON) : IGlobalJSON;
declare function createString (parameters? : IGlobalString) : IGlobalString;
declare function createconsole (parameters? : IGlobalConsole) : IGlobalConsole;
