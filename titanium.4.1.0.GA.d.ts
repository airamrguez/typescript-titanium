/*
   Typescript Titanium - 4.1.0.GA
   Typescipt-Titanium may be freely distributed under the MIT license.
   This source code was auto-generated (Sat Sep 26 2015 21:00:34 GMT-0400 (EDT)}}).
...
interface ITitaniumUIListView {
    ...
    setDividerHeight (dividerHeight : string) : IVoid;
...
interface ITitaniumUIScrollView {
    ...
    show () : IVoid;
    setContentOffset (contentOffset : any) : IVoid;
    setZoomScale (zoomScale : number) : IVoid;
