/*
   Typescript Titanium - 7.1.0.GA
   Typescipt-Titanium may be freely distributed under the MIT license.
   This source code was auto-generated (Sat Mar 17 2018 09:15:19 GMT-0400 (EDT)}}).
...
interface ITitaniumUIView {
    ...
    getViewById (id : string) : ITitaniumUIView;
    getBubbleParent () : boolean;
    setBubbleParent (bubbleParent : boolean) : IVoid;
    getApiName () : string;
    getLifecycleContainer () : ITitaniumUIWindow;
    ...
    setHiddenBehavior (hiddenBehavior : number) : IVoid;
    getLeft () : number;
    ...
    getPreviewContext () : ITitaniumUIIOSPreviewContext;
    setPreviewContext (previewContext : ITitaniumUIIOSPreviewContext) : IVoid;
    getRight () : number;
    ...
    setTouchFeedback (touchFeedback : boolean) : IVoid;
    getTouchFeedbackColor () : string;
    setTouchFeedbackColor (touchFeedbackColor : string) : IVoid;
...
interface ITitaniumUIAlertDialog {
    ...
    setPasswordhinttextid (passwordhinttextid : string) : IVoid;
    getPasswordReturnKeyType () : number;
    setPasswordReturnKeyType (passwordReturnKeyType : number) : IVoid;
    getPasswordValue () : string;
    setPasswordValue (passwordValue : string) : IVoid;
...
interface ITitaniumUIAndroidDrawerLayout {
    bubbleParent : boolean;
    apiName : string;
    lifecycleContainer : ITitaniumUIWindow;
    accessibilityHidden : boolean;
    ...
    openRight () : IVoid;
    closeRight () : IVoid;
    interceptTouchEvent (view : ITitaniumUIView, disallowIntercept : boolean) : IVoid;
    getBubbleParent () : boolean;
    setBubbleParent (bubbleParent : boolean) : IVoid;
    getApiName () : string;
    getLifecycleContainer () : ITitaniumUIWindow;
    ...
    setIsLeftOpen (isLeftOpen : boolean) : IVoid;
    getIsRightOpen () : boolean;
    setIsRightOpen (isRightOpen : boolean) : IVoid;
    getIsLeftVisible () : boolean;
    setIsLeftVisible (isLeftVisible : boolean) : IVoid;
    getIsRightVisible () : boolean;
    setIsRightVisible (isRightVisible : boolean) : IVoid;
    getLeftWidth () : number;
    setLeftWidth (leftWidth : number) : IVoid;
    getRightWidth () : number;
    setRightWidth (rightWidth : number) : IVoid;
    ...
    getCenterView () : ITitaniumUIView;
    setCenterView (centerView : ITitaniumUIView) : IVoid;
    getDrawerIndicatorEnabled () : boolean;
    setDrawerIndicatorEnabled (drawerIndicatorEnabled : boolean) : IVoid;
    getDrawerLockMode () : number;
    setDrawerLockMode (drawerLockMode : number) : IVoid;
    getToolbarEnabled () : boolean;
    setToolbarEnabled (toolbarEnabled : boolean) : IVoid;
    getToolbar () : ITitaniumUIToolbar;
    setToolbar (toolbar : ITitaniumUIToolbar) : IVoid;
}
...
interface ITitaniumUIAndroid {
    ...
    DrawerLayout : ITitaniumUIAndroidDrawerLayout;
    ...
    createDrawerLayout (parameters? : ITitaniumUIAndroidDrawerLayout) : ITitaniumUIAndroidDrawerLayout;
...
interface ITitaniumUIClipboard {
    ...
    getUnique () : boolean;
    setUnique (unique : boolean) : IVoid;
    getAllowCreation () : boolean;
    setAllowCreation (allowCreation : boolean) : IVoid;
}
...
interface ITitaniumUIListItem {
    ...
    setSelectedSubtitleColor (selectedSubtitleColor : string) : IVoid;
}
...
interface ITitaniumUIListView {
    ...
    setAllowsMultipleSelectionDuringEditing (allowsMultipleSelectionDuringEditing : boolean) : IVoid;
    ...
    setDimBackgroundForSearch (dimBackgroundForSearch : boolean) : IVoid;
    getResultsBackgroundColor () : string;
    setResultsBackgroundColor (resultsBackgroundColor : string) : IVoid;
    getResultsSeparatorColor () : string;
    setResultsSeparatorColor (resultsSeparatorColor : string) : IVoid;
    getResultsSeparatorStyle () : number;
    setResultsSeparatorStyle (resultsSeparatorStyle : number) : IVoid;
    getResultsSeparatorInsets () : any;
    setResultsSeparatorInsets (resultsSeparatorInsets : any) : IVoid;
    getSelectedItems () : any[];
    setSelectedItems (selectedItems : any[]) : IVoid;
}
...
interface ITitaniumUIScrollView {
    ...
    convertPointToView (point : IPoint, destinationView : ITitaniumUIView) : IPoint;
    getViewById (id : string) : ITitaniumUIView;
    scrollTo (x : number, y : number, animation? : IScrollViewAnimationProperties) : IVoid;
    setContentOffset (contentOffset : any) : IVoid;
...
interface ITitaniumUISlider {
    ...
    setSplitTrack (splitTrack : boolean) : IVoid;
...
interface ITitaniumUITab {
    ...
    setBadgeColor (badgeColor : string) : IVoid;
    getIcon () : string;
...
interface ITitaniumUITextArea {
    ...
    setAutofillType (autofillType : string) : IVoid;
    getAutoLink () : number;
    setAutoLink (autoLink : number) : IVoid;
    ...
    setHintTextColor (hintTextColor : string) : IVoid;
    getHintType () : number;
    setHintType (hintType : number) : IVoid;
...
interface ITitaniumUIToolbar {
    ...
    convertPointToView (point : IPoint, destinationView : ITitaniumUIView) : IPoint;
    getViewById (id : string) : ITitaniumUIView;
    collapseActionViews () : IVoid;
    dismissPopupMenus () : IVoid;
    ...
    hideOverflowMenu () : IVoid;
    isOverflowMenuShowing () : boolean;
    setContentInsetsAbsolute (insetLeft : number, insetRight : number) : IVoid;
    setContentInsetsRelative (insetStart : number, insetEnd : number) : IVoid;
    showOverflowMenu () : IVoid;
    getBubbleParent () : boolean;
    setBubbleParent (bubbleParent : boolean) : IVoid;
    getApiName () : string;
    getLifecycleContainer () : ITitaniumUIWindow;
    ...
    setContentInsetEndWithActions (contentInsetEndWithActions : number) : IVoid;
    getContentInsetStartWithNavigation () : number;
    setContentInsetStartWithNavigation (contentInsetStartWithNavigation : number) : IVoid;
    getLogo () : string;
    setLogo (logo : string) : IVoid;
    getNavigationIcon () : string;
    setNavigationIcon (navigationIcon : string) : IVoid;
    getOverflowIcon () : string;
    setOverflowIcon (overflowIcon : string) : IVoid;
    getSubtitle () : string;
    setSubtitle (subtitle : string) : IVoid;
    getSubtitleTextColor () : string;
    setSubtitleTextColor (subtitleTextColor : string) : IVoid;
    getTitle () : string;
    setTitle (title : string) : IVoid;
    getTitleTextColor () : string;
    setTitleTextColor (titleTextColor : string) : IVoid;
}
interface ITitaniumUIWebView {
    ...
    setDisableContextMenu (disableContextMenu : boolean) : IVoid;
    ...
    setKeyboardDisplayRequiresUserAction (keyboardDisplayRequiresUserAction : boolean) : IVoid;
    ...
    setRequestHeaders (requestHeaders : any) : IVoid;
}
interface ITitaniumUIWindow {
    ...
    setExtendSafeArea (extendSafeArea : boolean) : IVoid;
    getFullscreen () : boolean;
    setFullscreen (fullscreen : boolean) : IVoid;
    ...
    setLargeTitleEnabled (largeTitleEnabled : string) : IVoid;
    getLargeTitleDisplayMode () : number;
    setLargeTitleDisplayMode (largeTitleDisplayMode : number) : IVoid;
    ...
    setSustainedPerformanceMode (sustainedPerformanceMode : boolean) : IVoid;
...
interface ITitaniumUIIOSFeedbackGenerator {
    ...
    notificationOccurred (notificationType : number) : IVoid;
    getBubbleParent () : boolean;
    setBubbleParent (bubbleParent : boolean) : IVoid;
    getApiName () : string;
    getType () : number;
...
interface ITitaniumUIIOSSystemIcon {
    bubbleParent : boolean;
    apiName : string;
    BOOKMARKS : number;
    CONTACTS : number;
...
interface ITitaniumUIIOS {
    ...
    SystemIcon : ITitaniumUIIOSSystemIcon;
    ...
    createLivePhotoBadge (type : number) : ITitaniumBlob;
    ...
    createMenuPopup (parameters? : ITitaniumUIIOSMenuPopup) : ITitaniumUIIOSMenuPopup;
    ...
    setMODAL_PRESENTATION_CURRENT_CONTEXT (MODAL_PRESENTATION_CURRENT_CONTEXT : number) : IVoid;
    getAppBadge () : number;
...
interface ITitaniumAndroidActivity {
    ...
    supportToolbar : ITitaniumUIToolbar;
    addEventListener (name : string, callback : (...args : any[]) => any) : IVoid;
    removeEventListener (name : string, callback : (...args : any[]) => any) : IVoid;
    fireEvent (name : string, event : any) : IVoid;
    applyProperties (props : any) : IVoid;
    ...
    setRequestedOrientation (requestedOrientation : number) : IVoid;
    setResult (resultCode : number, intent? : ITitaniumAndroidIntent) : IVoid;
    setSupportActionBar (toolbar : ITitaniumUIToolbar) : IVoid;
    ...
    getSupportToolbar () : ITitaniumUIToolbar;
    setSupportToolbar (supportToolbar : ITitaniumUIToolbar) : IVoid;
}
interface ITitaniumAndroidBigPictureStyle {
    ...
    getLifecycleContainer () : ITitaniumUIWindow;
    setLifecycleContainer (lifecycleContainer : ITitaniumUIWindow) : IVoid;
    getBigLargeIcon () : number;
    setBigLargeIcon (bigLargeIcon : number) : IVoid;
    getBigPicture () : number;
    setBigPicture (bigPicture : number) : IVoid;
    getBigContentTitle () : string;
    setBigContentTitle (bigContentTitle : string) : IVoid;
    getDecodeRetries () : number;
    setDecodeRetries (decodeRetries : number) : IVoid;
    getSummaryText () : string;
    setSummaryText (summaryText : string) : IVoid;
}
interface ITitaniumAndroidBigTextStyle {
    ...
    setLifecycleContainer (lifecycleContainer : ITitaniumUIWindow) : IVoid;
    getBigText () : string;
    setBigText (bigText : string) : IVoid;
    getBigContentTitle () : string;
    setBigContentTitle (bigContentTitle : string) : IVoid;
    getSummaryText () : string;
    setSummaryText (summaryText : string) : IVoid;
...
interface ITitaniumAndroidNotification {
    ...
    setProgress (max : number, progress : number, indeterminate : boolean) : IVoid;
    addAction (icon : number, title : string, intent : ITitaniumAndroidPendingIntent) : IVoid;
    getBubbleParent () : boolean;
    setBubbleParent (bubbleParent : boolean) : IVoid;
    getApiName () : string;
    getLifecycleContainer () : ITitaniumUIWindow;
    ...
    setFlags (flags : number) : IVoid;
    getGroupKey () : string;
    setGroupKey (groupKey : string) : IVoid;
    getGroupSummary () : boolean;
    setGroupSummary (groupSummary : boolean) : IVoid;
    getIcon () : number;
    setIcon (icon : number) : IVoid;
    getLargeIcon () : number;
    ...
    getWakeLock () : IWakeLockOptions;
    setWakeLock (wakeLock : IWakeLockOptions) : IVoid;
    getWhen () : Date;
    setWhen (when : Date) : IVoid;
}
interface ITitaniumAndroidNotificationChannel {
    bubbleParent : boolean;
    apiName : string;
    lifecycleContainer : ITitaniumUIWindow;
    bypassDnd : boolean;
    ...
    setBypassDnd (bypassDnd : boolean) : IVoid;
    getDescription () : string;
    setDescription (description : string) : IVoid;
    getEnableLights () : boolean;
    setEnableLights (enableLights : boolean) : IVoid;
    getEnableVibration () : boolean;
    setEnableVibration (enableVibration : boolean) : IVoid;
    getGroupId () : string;
    setGroupId (groupId : string) : IVoid;
    getImportance () : number;
    setImportance (importance : number) : IVoid;
    getId () : string;
    setId (id : string) : IVoid;
    getLightColor () : number;
    setLightColor (lightColor : number) : IVoid;
    getLockscreenVisibility () : number;
    setLockscreenVisibility (lockscreenVisibility : number) : IVoid;
    getShowBadge () : boolean;
    setShowBadge (showBadge : boolean) : IVoid;
    getVibratePattern () : any[];
    setVibratePattern (vibratePattern : any[]) : IVoid;
}
interface ITitaniumAndroidNotificationManager {
    ...
    createNotificationChannel (parameters : ITitaniumAndroidNotificationChannel) : ITitaniumAndroidNotificationChannel;
...
interface ITitaniumAndroidQuickSettingsService {
    bubbleParent : boolean;
    apiName : string;
    lifecycleContainer : ITitaniumUIWindow;
    intent : ITitaniumAndroidIntent;
    ...
    updateTile () : IVoid;
    setIcon (icon : string) : IVoid;
    setState (state : number) : IVoid;
    setLabel (label : string) : IVoid;
    getIcon () : string;
    getState () : number;
    isSecure () : boolean;
    showDialog (options : IShowParams) : IVoid;
    startActivityAndCollapse (intent : ITitaniumAndroidIntent) : IVoid;
    unlockAndRun (jsCode : string) : IVoid;
    getBubbleParent () : boolean;
    setBubbleParent (bubbleParent : boolean) : IVoid;
    getApiName () : string;
    getLifecycleContainer () : ITitaniumUIWindow;
...
interface ITitaniumAndroid {
    ...
    NotificationChannel : ITitaniumAndroidNotificationChannel;
    NotificationManager : ITitaniumAndroidNotificationManager;
    PendingIntent : ITitaniumAndroidPendingIntent;
    QuickSettingsService : ITitaniumAndroidQuickSettingsService;
    R : ITitaniumAndroidR;
    ...
    requestPermissions (permissions : string, callback? : (...args : any[]) => any) : IVoid;
    ...
    getLifecycleContainer () : ITitaniumUIWindow;
    setLifecycleContainer (lifecycleContainer : ITitaniumUIWindow) : IVoid;
    createBigPictureStyle (parameters? : ITitaniumAndroidBigPictureStyle) : ITitaniumAndroidBigPictureStyle;
    createBigTextStyle (parameters? : ITitaniumAndroidBigTextStyle) : ITitaniumAndroidBigTextStyle;
    ...
    createNotificationChannel (parameters? : ITitaniumAndroidNotificationChannel) : ITitaniumAndroidNotificationChannel;
    createQuickSettingsService (parameters? : ITitaniumAndroidQuickSettingsService) : ITitaniumAndroidQuickSettingsService;
...
interface ITitaniumBlob {
    ...
    imageAsCompressed (quality : number) : ITitaniumBlob;
...
interface ITitaniumLocale {
    ...
    setLanguage (language : string) : IVoid;
...
interface ITitaniumMediaAudioPlayer {
    ...
    setAudioFocus (audioFocus : boolean) : IVoid;
    getAudioType () : number;
    setAudioType (audioType : number) : IVoid;
    getBitRate () : number;
...
interface ITitaniumMediaSystemAlert {
    bubbleParent : boolean;
    apiName : string;
    url : string;
    addEventListener (name : string, callback : (...args : any[]) => any) : IVoid;
...
interface ITitaniumMediaVideoPlayer {
    ...
    getOverlayView () : ITitaniumUIView;
    setOverlayView (overlayView : ITitaniumUIView) : IVoid;
    getPictureInPictureEnabled () : boolean;
    setPictureInPictureEnabled (pictureInPictureEnabled : boolean) : IVoid;
    ...
    setShowsControls (showsControls : boolean) : IVoid;
    getSourceType () : number;
...
interface ITitaniumMedia {
    ...
    SystemAlert : ITitaniumMediaSystemAlert;
    ...
    VIDEO_LOAD_STATE_FAILED : number;
    ...
    VIDEO_SCALING_RESIZE : string;
    VIDEO_SCALING_RESIZE_ASPECT : string;
    VIDEO_SCALING_RESIZE_ASPECT_FILL : string;
    ...
    requestAudioRecorderPermissions (callback : (...args : any[]) => any) : IVoid;
    ...
    createSystemAlert (parameters? : ITitaniumMediaSystemAlert) : ITitaniumMediaSystemAlert;
...
interface ITitaniumPlatform {
    ...
    getId () : string;
    getIdentifierForVendor () : string;
    getIdentifierForAdvertising () : string;
    setIdentifierForAdvertising (identifierForAdvertising : string) : IVoid;
    getIsAdvertisingTrackingEnabled () : boolean;
    getLocale () : string;
...
interface IMediaQueryType {
    ...
    playCount : IMediaQueryInfoType;
    persistentID : IMediaQueryInfoType;
    albumPersistentID : IMediaQueryInfoType;
    albumArtistPersistentID : IMediaQueryInfoType;
    genrePersistentID : IMediaQueryInfoType;
    composerPersistentID : IMediaQueryInfoType;
    isCloudItem : IMediaQueryInfoType;
    hasProtectedAsset : IMediaQueryInfoType;
    podcastTitle : IMediaQueryInfoType;
    podcastPersistentID : IMediaQueryInfoType;
}
...
interface IListItemEventType {
    section : ITitaniumUIListSection;
    sectionIndex : number;
    itemIndex : number;
    itemId : string;
}
...
interface IScrollViewAnimationProperties {
    animated : boolean;
}
...
declare var wakeLockOptions : IWakeLockOptions;
...
declare var ListItemEventType : IListItemEventType;
...
declare var ScrollViewAnimationProperties : IScrollViewAnimationProperties;
